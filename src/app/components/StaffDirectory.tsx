          ...
          {filteredTeachers.length > 0 ? (
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="text-[10px] text-[#059669] font-bold uppercase tracking-wider mt-0.5">
                          {teacher.subject} • {teacher.section || teacher.role}
                        </p>
            ...
            <div className="py-20 text-center">
              <div className="w-16 h-16 rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center mx-auto mb-4">
                <Search className="w-8 h-8 text-[#059669]/30" />
              </div>
              <p className="text-[#a0b5a3] text-xs font-bold uppercase tracking-widest">No teachers found</p>
            </div>
          )}
        </div>
