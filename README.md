...
🚀 Core Features
    ...
    Cross-Platform Architecture: Built with React and TypeScript, ready for both Vercel web deployment and Android APK distribution.
...
🛠️ Technical Stack
    ...
    State Management: React Context API for handling global campus data and navigation states.

    Backend & Storage: Supabase integration for data persistence and Vercel for automated CI/CD.
